...
{	
	...
	{	
		...
		var fmh_197_64_638561360610011731 = point.transform.rotation; Vector3 newPosition = Handles.FreeMoveHandle(point.position, HandleUtility.GetHandleSize(point.position)*0.1f, Vector3.zero, Handles.RectangleHandleCap);
		...
		if(point.handleStyle != BezierPoint.HandleStyle.None)
		{
			...
			var fmh_208_69_638561360610036582 = point.transform.rotation; Vector3 newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, HandleUtility.GetHandleSize(point.globalHandle1)*0.075f, Vector3.zero, Handles.CircleHandleCap);
			...
			var fmh_216_69_638561360610055967 = point.transform.rotation; Vector3 newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, HandleUtility.GetHandleSize(point.globalHandle2)*0.075f, Vector3.zero, Handles.CircleHandleCap);
