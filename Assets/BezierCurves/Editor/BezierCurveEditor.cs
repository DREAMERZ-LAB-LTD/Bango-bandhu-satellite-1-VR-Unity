...
{	
	...
	{	
		...
		var fmh_197_64_638561376862772091 = point.transform.rotation; Vector3 newPosition = Handles.FreeMoveHandle(point.position, HandleUtility.GetHandleSize(point.position)*0.1f, Vector3.zero, Handles.RectangleHandleCap);
		...
		if(point.handleStyle != BezierPoint.HandleStyle.None)
		{
			...
			var fmh_208_69_638561376862792260 = point.transform.rotation; Vector3 newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, HandleUtility.GetHandleSize(point.globalHandle1)*0.075f, Vector3.zero, Handles.CircleHandleCap);
			...
			var fmh_216_69_638561376862794932 = point.transform.rotation; Vector3 newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, HandleUtility.GetHandleSize(point.globalHandle2)*0.075f, Vector3.zero, Handles.CircleHandleCap);
